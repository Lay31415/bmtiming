...
local function populate_main_menu(config)
...
local function handle_main_menu(index, event, config)
...
function lib:populate_menu(config)
    return populate_main_menu(config)
end

function lib:handle_menu_event(index, event, config)
    return handle_main_menu(index, event, config)
end
